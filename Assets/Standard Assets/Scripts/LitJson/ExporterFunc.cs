...
namespace LitJson
{
    internal sealed class ExporterFunc : MulticastDelegate
    {
        ...
        {
            mem[1152921510968342296] = method;
            mem[1152921510968342304] = object;
            mem[1152921510968342308] = method;
        }
        public virtual void Invoke(object obj, LitJson.JsonWriter writer)
        {
                    ...
                    if(obj == 0)
            {
                ...
                val_13 = 1152921510968466592;
            }
            
            LitJson.JsonWriter val_1 = writer - 8;
            var val_21 = 0;
            object val_2 = obj - 8;
            goto label_49;
            label_44:
