...
namespace LitJson
{
    public sealed class ImporterFunc<TJson, TValue> : MulticastDelegate
    {
        ...
        {
            mem[1152921510969866520] = method;
            mem[1152921510969866528] = object;
            mem[1152921510969866532] = method;
        }
        public virtual TValue Invoke(TJson input)
        {
            ...
            label_7:
            var val_12 = R7 + 40;
            val_12 = 1152921504626761728 + (val_12 << 3);
            goto label_45;
            label_12:
