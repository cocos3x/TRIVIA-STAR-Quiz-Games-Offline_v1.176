...
namespace AudienceNetwork
{
    internal sealed class FBRewardedVideoAdBridgeErrorExternalCallback : MulticastDelegate
    {
        ...
        {
            mem[1152921514517337592] = method;
            mem[1152921514517337600] = object;
            mem[1152921514517337604] = method;
        }
        public virtual void Invoke(int uniqueId, string error)
        {
            ...
            goto label_16;
            label_28:
            val_11 = mem[1152921514517457796];
            if(val_11 == 0)
            {
                goto label_14;
            }
            
            if((mem[1152921514517457796] + 42) != 2)
            {
                goto label_27;
            }
            ...
            goto label_16;
            label_14:
            if(mem[1152921514517457792] == 0)
            {
                goto label_17;
            }
            
            if((((mem[1152921514517457796] + 40) == 65535) || ((mem[1152921514517457792] + 157) != 1)) || (mem[1152921514517457788] == 0))
            {
                goto label_27;
            }
            ...
            val_3 = mem[1152921514517457796] + 40;
            if((mem[1152921514517457792] + 178) == 0)
            {
                goto label_16;
            }
            ...
            var val_11 = 0;
            label_25:
            if((mem[1152921514517457792] + 88 + 0) == (mem[1152921514517457796] + 12))
            {
                goto label_24;
            }
            
            val_11 = val_11 + 1;
            if(((uint)val_11 & 65535) < (mem[1152921514517457792] + 178))
            {
                goto label_25;
            }
