...
public class AttackMadnessEcon
{
    ...
    public AttackMadnessEcon(System.Collections.Generic.Dictionary<string, object> eventDataDict)
    {
        ...
        AttackMadnessRewardData val_1 = AttackMadnessEconDataHelper.ParseCSV();
            ...
            if(0 != 0)
        {
            ...
            bool val_12 = System.Int32.TryParse(s:  null, result: out  int val_11 = -1554521112);
            if(val_12 == true)
        {
                val_12 = 0;
            ...
            if(0 != 0)
        {
            ...
            bool val_17 = System.Int32.TryParse(s:  null, result: out  int val_16 = -1554521116);
            if(val_17 == true)
        {
                val_17 = 0;
            ...
            if(0 != 0)
        {
            ...
            bool val_25 = System.Single.TryParse(s:  null, result: out  float val_24 = -1.170343E-17f);
            if(val_25 == true)
        {
                val_25 = 0;
            ...
            if(0 != 0)
        {
            ...
            bool val_30 = System.Single.TryParse(s:  null, result: out  float val_29 = -1.170342E-17f);
            if(val_30 == true)
        {
                val_30 = 0;
        ...
        bool val_35 = System.Single.TryParse(s:  null, result: out  float val_34 = -1.170342E-17f);
        if(val_35 == true)
        {
                val_35 = 0;
    ...
    public decimal GetGrandPrizeSpinAmount(int playerTier)
    {
                ...
                if((playerTier + 12) <= SB)
        {
            ...
            decimal val_3 = System.Decimal.op_Addition(d1:  new System.Decimal() {flags = -1553612964}, d2:  new System.Decimal() {hi = playerTier + 8 + 16 + 16, lo = mem[(playerTier + 8 + 16 + 20) + (0)], mid = mem[(playerTier + 8 + 16 + 20) + (4)]});
            val_9 = val_4;
            val_10 = val_5;
            val_11 = val_6;
        }
        ...
        this = val_9;
        mem[1152921511643180660] = val_10;
        mem[1152921511643180664] = val_11;
        mem[1152921511643180668] = val_7;
        return new System.Decimal() {flags = -1553600912, hi = val_7, lo = val_3.lo, mid = val_3.mid};
    }
    public RESEventRewardData GetFinalPrize(int playerTier)
    {
        ...
        AttackMadnessRewardData val_2 = this.rewardData;
