using UnityEngine;
private sealed class AttackStartLightning.<FadeSize>d__11 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public AttackStartLightning.<FadeSize>d__11(int <>1__state)
    {
