using UnityEngine;
public class RESAttackExplosionEffects : MonoBehaviour
{
    // Fields
    ...
    {
        this.RefreshLine();
        this.explosion.SetActive(value:  false);
    ...
    private System.Collections.IEnumerator AnimateLightning()
    {
        ...
        typeof(RESAttackExplosionEffects.<AnimateLightning>d__10).__il2cppRuntimeField_8 = 0;
        typeof(RESAttackExplosionEffects.<AnimateLightning>d__10).__il2cppRuntimeField_10 = this;
    }
    ...
    {
        typeof(RESAttackExplosionEffects.<FadeSize>d__12).__il2cppRuntimeField_8 = 0;
        if(new System.Object() != 0)
        {
                typeof(RESAttackExplosionEffects.<FadeSize>d__12).__il2cppRuntimeField_1C = this;
            typeof(RESAttackExplosionEffects.<FadeSize>d__12).__il2cppRuntimeField_14 = R1;
            typeof(RESAttackExplosionEffects.<FadeSize>d__12).__il2cppRuntimeField_18 = R2;
        }
        else
        {
                mem[28] = this;
        ...
        typeof(RESAttackExplosionEffects.<FadeSize>d__12).__il2cppRuntimeField_10 = R3;
    }
    public RESAttackExplosionEffects()
    {
        this.duration = 0.8f;
        this.lineWidth = 0.2f;
        this.maxLength = 1f;
