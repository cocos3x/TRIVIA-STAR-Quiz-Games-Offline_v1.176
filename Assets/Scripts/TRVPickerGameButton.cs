...
public class TRVPickerGameButton : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        UnityEngine.Events.UnityAction val_2 = new UnityEngine.Events.UnityAction(object:  -476156928, method:  new IntPtr(3818777152));
    ...
    public void RevealMe(bool selected)
    {
        ...
        UnityEngine.Coroutine val_2 = this.StartCoroutine(routine:  -475916544);
    }
    private System.Collections.IEnumerator doReveal(bool selected)
    {
        typeof(TRVPickerGameButton.<doReveal>d__14).__il2cppRuntimeField_8 = 0;
        if(new System.Object() != 0)
        {
                typeof(TRVPickerGameButton.<doReveal>d__14).__il2cppRuntimeField_10 = this;
        }
        else
        {
                mem[16] = this;
        ...
        typeof(TRVPickerGameButton.<doReveal>d__14).__il2cppRuntimeField_14 = selected;
    }
