using UnityEngine;
public class WOLPackageDefinitions : PackageDefinitions
{
    // Fields
    ...
    public WOLPackageDefinitions()
    {
        ...
        float val_4 = UnityEngine.Mathf.Max(a:  0f, b:  null);
        Add(key:  2129282688, value:  15282176);
        ...
        Add(key:  1624646480, value:  -752095136);
        Add(key:  2129282688, value:  13152256);
        Add(key:  -1816221696, value:  15282176);
        Add(item:  78753792);
        ...
        Add(key:  1624646480, value:  -684647248);
        Add(key:  2129282688, value:  13152256);
        Add(key:  -1816221696, value:  15282176);
        Add(item:  78753792);
        ...
        Add(key:  1624646480, value:  -684647152);
        Add(key:  2129282688, value:  13152256);
        Add(key:  -1816221696, value:  15282176);
        Add(item:  78753792);
        mem[1152921512512158548] = null;
    }
