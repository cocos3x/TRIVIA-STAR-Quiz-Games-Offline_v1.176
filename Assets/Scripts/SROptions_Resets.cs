...
public class SROptions_Resets : SuperLuckySROptionsParent<SROptions_Resets>, INotifyPropertyChanged
{
    ...
    public void ResetInvites()
    {
        ...
        string val_2 = System.String.Format(format:  -840663728, arg0:  1835037);
        App.networkManager.DoPost(path:  -840663728, postBody:  0, onCompleteFunction:  0, timeout:  20, destroy:  false, immediate:  false, serverType:  0);
    }
