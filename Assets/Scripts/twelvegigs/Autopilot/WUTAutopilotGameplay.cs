...
namespace twelvegigs.Autopilot
{
    public class WUTAutopilotGameplay : AutopilotGameplay
    {
        ...
        public override void OnSceneLoaded(SceneType sceneType)
        {
            ...
            UnityEngine.Events.UnityAction val_7 = new UnityEngine.Events.UnityAction(object:  1125009824, method:  new IntPtr(1124984800));
        ...
        public override void OnSceneUnloaded(SceneType sceneType)
        {
            ...
            UnityEngine.Events.UnityAction val_2 = new UnityEngine.Events.UnityAction(object:  1125130016, method:  new IntPtr(1124984800));
        ...
        public void HandleLevelComplete()
        {
            ...
            else
            {
                ...
                val_15 = ChapterBookLogic.ShowChapterComplete(playerLevel:  0);
                Player val_9 = App.Player;
                val_14 = ChapterBookLogic.ShowBookComplete(playerLevel:  0);
            }
            ...
            if(val_14 != false)
            {
                ...
                val_17 = "Button_BookSelected_TapToContinue";
            }
            else
            {
                    if(val_15 != false)
            {
                    val_16 = public System.Void System.Collections.Generic.List<System.String>::Add(System.String item);
                val_17 = "ChapterClear_collect_button";
            }
            else
            {
                    val_16 = public System.Void System.Collections.Generic.List<System.String>::Add(System.String item);
                val_17 = "click_to_continue";
            }
