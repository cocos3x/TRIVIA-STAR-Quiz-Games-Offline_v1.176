...
public class WADGameplayBehavior : GameplayBehavior
{
    ...
    public override string StoreBonusAmountText(decimal rawPercent)
    {
        ...
        decimal val_3 = System.Decimal.op_Multiply(d1:  new System.Decimal() {flags = -714473400, hi = rawPercent.flags, lo = rawPercent.hi, mid = rawPercent.lo}, d2:  new System.Decimal() {flags = rawPercent.mid, hi = val_2.flags, lo = val_2.hi, mid = val_2.lo});
        decimal val_5 = System.Math.Round(d:  new System.Decimal() {flags = -714473416});
        string val_6 = val_2.flags.ToString();
        string val_7 = System.String.Format(format:  -714485424, arg0:  -714473384);
    }
