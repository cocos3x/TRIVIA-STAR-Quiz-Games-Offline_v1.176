...
public class SROptions_WordNut : SuperLuckySROptionsParent<SROptions_WordNut>, INotifyPropertyChanged
{
    ...
    public void InfinityModeInfoHUD()
    {
        var val_5;
        twelvegigs.Autopilot.AutopilotManager val_1 = MonoSingleton<twelvegigs.Autopilot.AutopilotManager>.Instance;
        System.Func<TRVQuizProgress> val_2 = new System.Func<TRVQuizProgress>(object:  -902550112, method:  new IntPtr(3487859904));
        SLCHUDWindow.SetupHUD(name:  -807106368, callbackfunc:  7667712);
        SRDebugger.Services.IDebugService val_3 = SRDebug.Instance;
        if(mem[1179403825] == 0)
        {
            goto label_4;
