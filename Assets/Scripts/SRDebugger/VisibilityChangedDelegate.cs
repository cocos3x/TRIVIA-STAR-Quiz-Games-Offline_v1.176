...
namespace SRDebugger
{
    public sealed class VisibilityChangedDelegate : MulticastDelegate
    {
        ...
        {
            mem[1152921513610746872] = method;
            mem[1152921513610746880] = object;
            mem[1152921513610746884] = method;
        }
        public virtual void Invoke(bool isVisible)
        {
            ...
            goto label_16;
            label_28:
            val_8 = mem[1152921513610862980];
            if(val_8 == 0)
            {
                goto label_14;
            }
            
            if((mem[1152921513610862980] + 42) != 1)
            {
                goto label_27;
            }
            ...
            goto label_16;
            label_14:
            if(mem[1152921513610862976] == 0)
            {
                goto label_17;
            }
            
            if((((mem[1152921513610862980] + 40) == 65535) || ((mem[1152921513610862976] + 157) != 1)) || (mem[1152921513610862972] == 0))
            {
                goto label_27;
            }
            ...
            val_2 = mem[1152921513610862980] + 40;
            if((mem[1152921513610862976] + 178) == 0)
            {
                goto label_26;
            }
            ...
            var val_10 = 0;
            label_25:
            if((mem[1152921513610862976] + 88 + 0) == (mem[1152921513610862980] + 12))
            {
                goto label_24;
            }
            
            val_10 = val_10 + 1;
            if(((uint)val_10 & 65535) < (mem[1152921513610862976] + 178))
            {
                goto label_25;
            }
