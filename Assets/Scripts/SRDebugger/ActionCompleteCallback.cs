...
namespace SRDebugger
{
    public sealed class ActionCompleteCallback : MulticastDelegate
    {
        ...
        {
            mem[1152921513611227640] = method;
            mem[1152921513611227648] = object;
            mem[1152921513611227652] = method;
        }
        public virtual void Invoke(bool success)
        {
            ...
            goto label_16;
            label_28:
            val_8 = mem[1152921513611343748];
            if(val_8 == 0)
            {
                goto label_14;
            }
            
            if((mem[1152921513611343748] + 42) != 1)
            {
                goto label_27;
            }
            ...
            goto label_16;
            label_14:
            if(mem[1152921513611343744] == 0)
            {
                goto label_17;
            }
            
            if((((mem[1152921513611343748] + 40) == 65535) || ((mem[1152921513611343744] + 157) != 1)) || (mem[1152921513611343740] == 0))
            {
                goto label_27;
            }
            ...
            val_2 = mem[1152921513611343748] + 40;
            if((mem[1152921513611343744] + 178) == 0)
            {
                goto label_26;
            }
            ...
            var val_10 = 0;
            label_25:
            if((mem[1152921513611343744] + 88 + 0) == (mem[1152921513611343748] + 12))
            {
                goto label_24;
            }
            
            val_10 = val_10 + 1;
            if(((uint)val_10 & 65535) < (mem[1152921513611343744] + 178))
            {
                goto label_25;
            }
